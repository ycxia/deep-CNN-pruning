...
## 训练命令
python --epoch 500 --learning_rate 0.00006 --batch_size 64 --dataset cifar-10-batches-py --testset_size 10000 --l2_lambda=0.0005 --checkpoint_dir=drive/weights/vgg16_cifar10
